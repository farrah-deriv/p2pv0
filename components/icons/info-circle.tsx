...
export const InfoCircleIcon = ({ className }: InfoCircleIconProps) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    aria-hidden="true"
    // Always keep a default size — callers often pass shrink/mt classes and
    // previously wiped size-5 via `className ??`, making the SVG huge in flex.
