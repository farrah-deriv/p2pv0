...
const inputVariants = cva(
  "flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "border-input ring-offset-background placeholder:text-muted-foreground focus:border-black focus:outline-none focus:ring-0",
        secondary:
          "h-[32px] bg-white border border-input rounded-lg px-2 flex flex-row items-center gap-2 text-start focus-visible:outline-none focus:border-black focus:ring-0 placeholder:text-black/24 ps-10 pe-4",
        tertiary:
          "h-[32px] bg-gray-100 border-transparent rounded-lg px-2 flex flex-row items-center gap-2 text-start focus-visible:outline-none focus:border-black focus:ring-0 placeholder:text-black/24 ps-10 pe-4",
        floating:
