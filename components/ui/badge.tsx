  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        "success-light":
          "flex justify-center items-center rounded border-transparent bg-success-light text-xs font-bold leading-5 px-2 py-0.5 text-success-text",
        error: "border-transparent bg-error text-white hover:bg-error/80",
        "error-light":
          "flex justify-center items-center rounded border-transparent bg-error-light text-xs font-bold leading-5 px-2 py-0.5 text-error-text",
