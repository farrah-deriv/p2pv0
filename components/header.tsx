...
export default function Header() {
  ...
  // Original header nav items for mobile
  const hubNavItems = [
  ...
  return (
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-slate-200 z-10 h-16">
      ...
      {/* New desktop header */}
      <header className="hidden md:block fixed top-0 left-[280px] right-0 bg-white z-10 border-b border-slate-200">
        <div className="h-16">
